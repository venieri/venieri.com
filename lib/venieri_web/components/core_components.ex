defmodule VenieriWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_backpex({msg, opts}) do
    if count = opts[:count] do
      Gettext.dngettext(VenieriWeb.Gettext, "backpex", msg, msg, count, opts)
    else
      Gettext.dgettext(VenieriWeb.Gettext, "backpex", msg, opts)
    end
  end
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(VenieriWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(VenieriWeb.Gettext, "errors", msg, opts)
    end
  end
