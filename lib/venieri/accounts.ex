defmodule Venieri.Accounts do
  ...
  alias Venieri.Accounts.{User, UserToken, UserNotifier}
  ...
  See `Venieri.Accounts.User.email_changeset/3` for a list of supported options.
  ...
  See `Venieri.Accounts.User.password_changeset/3` for a list of supported options.
